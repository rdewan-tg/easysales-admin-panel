import { axiosAdminInstance, getSiteVisitReportByDateRangeEndpoint, getPhotoTransDatesEndpoint } from "@/core/data";
...
export const getTransDates= async () => {
    const response = await axiosAdminInstance.get<TransDateDto>(getPhotoTransDatesEndpoint);
