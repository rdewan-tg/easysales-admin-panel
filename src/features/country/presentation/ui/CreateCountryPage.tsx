...
const CreateCountryPage = () => {
    ...
    const [openCountryCreatedSnackBar, setCountryCreatedSnackBar] = useState(false);
    ...
    const onSubmit: SubmitHandler<CreateCountryForm> = async (formData: CreateCountryForm) => {
            ...
            <Controller
                ...
                render={({ field }) => (
                    <TextField
                        ...
                        helperText={errors.countryCode ? errors.countryCode.message : 'e.g. SG'} // Display error message
                        sx={{ width: '100%', maxWidth: 400 }}
                    />
                )}
            />
            ...
            <Controller
                ...
                render={({ field }) => (
                    <TextField
                        ...
                        helperText={errors.companyCode ? errors.companyCode.message : 'e.g. SGMA'} // Display error message
                        sx={{ width: '100%', maxWidth: 400 }}
                    />
                )}
            />
            ...
            <Controller
                ...
                render={({ field }) => (
                    <TextField
                        ...
                        helperText={errors.currencyCode ? errors.currencyCode.message : 'e.g. SGD'} // Display error message
                        sx={{ width: '100%', maxWidth: 400 }}
                    />
                )}
            />
            ...
            <Controller
                ...
                render={({ field }) => (
                    <TextField
                        ...
                        required={true}
                        error={!!errors.currencyCode} // Set error state
                        helperText={errors.currencyCode ? errors.currencyCode.message : 'e.g. Asia/Singapore'} // Display error message
                        sx={{ width: '100%', maxWidth: 400 }}
                    />
                )}
            />
