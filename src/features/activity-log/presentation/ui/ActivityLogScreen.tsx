            ...
            <Box
                ...
                >
                    <ColumnsDirective>
                        ...
                        <ColumnDirective field='userId' headerText='UserId' minWidth='50' width='70' maxWidth='100' textAlign="Left" />
                        <ColumnDirective field='action' headerText='Action' minWidth='100' width='200' textAlign="Left" />
                        <ColumnDirective field='level' headerText='Level' minWidth={'100'} maxWidth={'100'} textAlign="Left" />
                        <ColumnDirective field='timestamp' headerText='Timestamp' minWidth='150' width='150' maxWidth='250' textAlign="Left" />
                        <ColumnDirective field='details' headerText='Details' minWidth='150' textAlign="Left" />                        
                    </ColumnsDirective>
